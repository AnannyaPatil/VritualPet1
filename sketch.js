...
if(foodS == 0){
  ...
  textSize(17);
  fill("black");
  text("I am your Puppy 🐶 Zelda I am Hungry ",100,150);
  fill("black");
  text("Long Press up arrow key to feed your pet Dog Zelda",50,50);
  fill("black");
